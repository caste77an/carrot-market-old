...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      <div>
        <label className="w-full text-gray-600 cursor-pointer hover:border-orange-500 hover:text-orange-500 flex items-center justify-center border-2 border-dashed border-gray-300 h-48 rounded-md">
          <svg
            className="h-12 w-12"
            stroke="currentColor"
            fill="none"
      ...
      <div className="my-5">
        ...
        <div className="rounded-md shadow-sm relative flex items-center">
          ...
          <input
            ...
            type="text"
            placeholder="0.00"
            className="appearance-none pl-7 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placegray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
          />
