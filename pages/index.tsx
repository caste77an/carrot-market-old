...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 py-20 px-14 grid gap-10 min-h-screen">
      <div className="bg-white sm:hover:bg-pink-800 sm:bg-red-400 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-400 2xl:bg-pink-500 p-6 rounded-3xl shadow-xl flex flex-col">
