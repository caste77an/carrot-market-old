          ...
          <div className="mt-1">
            {method === "email" ? (
              <input
                id="input"
                type="email"
                className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placegray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                required
              />
            ) : null}
            {method === "phone" ? (
